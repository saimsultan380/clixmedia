      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-16 lg:gap-24 items-center">
        <div className="w-full lg:w-1/2 relative z-10">
          ...
          <div className="problem-fade inline-block relative group">
            <div className="absolute inset-0 bg-accent blur-xl opacity-20 group-hover:opacity-40 transition-opacity duration-500 rounded-lg" />
        ...
        <div className="w-full lg:w-1/2 relative z-10">
          <div className="flex flex-col space-y-4">
            {points.map((point, i) => (
              <div
                key={i}
                className="problem-fade group relative p-[1px] rounded-2xl overflow-hidden transition-all duration-500 hover:-translate-y-1 hover:shadow-[0_8px_30px_rgb(0,0,0,0.5)]"
              >
                {/* Default border */}
                ...
                <div className="relative bg-[#111216] rounded-[15px] p-6 md:p-8 z-10 w-full h-full flex flex-col md:flex-row md:items-center gap-4 md:gap-6 overflow-hidden">
                  ...
                  <span className="relative z-10 text-4xl md:text-5xl font-display text-accent/30 group-hover:text-accent/50 transition-colors duration-500">
                    0{i + 1}
                  </span>
